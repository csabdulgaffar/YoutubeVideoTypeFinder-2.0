  ...
  if (filter == 1) {
    ...
    https.get(url, response => {
      ...
      response.on("end", () => {
        ...
        res.render("result", { videoTitle: title, channelName: channelTitle, videoTags: tagsfinal, videoDescription: description, videoThumbnail:thumbnail , finalresult:resultIs});
